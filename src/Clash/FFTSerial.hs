...
fftBase :: (HiddenClockReset dom gated sync, Num a) => Signal dom Bool -> Signal dom (Complex a, Complex a) -> Signal dom (Complex a, Complex a)
...
fftSerialDITStep
    :: forall dom gated sync n a. (HiddenClockReset dom gated sync, KnownNat n, Num a)
...
fftSerialDIT
    :: forall dom gated sync a. (HiddenClockReset dom gated sync, Num a)
