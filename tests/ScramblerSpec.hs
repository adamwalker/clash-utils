...
prop_scramblerSerial :: BitVector 20 -> BitVector 19 -> [Bool] -> Property
...
prop_scramblerParallel :: BitVector 20 -> BitVector 19 -> [Vec 16 Bool] -> Property
